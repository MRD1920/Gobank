...
func TestPasetoMaker(t *testing.T) {
	...
	require.WithinDuration(t, issuedAt, token.RegisteredClaims.IssuedAt.Time, time.Second)
	require.WithinDuration(t, expiredAt, token.RegisteredClaims.ExpiresAt.Time, time.Second)
}
